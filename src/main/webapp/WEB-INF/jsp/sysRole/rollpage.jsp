 		...
 		<div class="page-bar">
			<ul class="page-num-ul clearfix">
				...
				<c:if test="${pageInfo.hasPreviousPage}">
					<a href="${pageContext.request.contextPath }/sys/storageRecord/list/1">首页</a>
					<a href="${pageContext.request.contextPath }/sys/storageRecord/list/${pageInfo.pageNum-1}">上一页</a>
				</c:if>
				<c:if test="${pageInfo.hasNextPage}">
					<a href="${pageContext.request.contextPath }/sys/storageRecord/list/${pageInfo.pageNum+1 }">下一页</a>
					<a href="${pageContext.request.contextPath }/sys/storageRecord/list/${pageInfo.pages}">尾页</a>
				</c:if>
				&nbsp;&nbsp;
			</ul>
...
<script type="text/javascript">
	function gogo(pageCount){
		...
		if (inoutPage > pageCount){
			...
			window.location.href = path+"/sys/storageRecord/list/"+inoutPage;
		}
	}
</script>
</html>