...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${pageContext.request.contextPath }/sys/storageRecord/list/1">
			<span>商品名称：</span>
...
<%--					<span><a href="${pageContext.request.contextPath }/sys/storageRecord/del/${storageRecord.id }" storageRecordId=${storageRecord.id } StorageRecordcc=${storageRecord.srCode }><img src="${pageContext.request.contextPath }/statics/images/del.png" alt="删除" title="删除"/></a></span>--%>
